...
export const directions = {
  car: '경기 안산시 단원구 광덕4로 140 지디팰리스타워 (고잔동 703)',
  subway: '4호선 고잔역 2번 출구에서 왼쪽 대로변 따라 200m 전방',
  // 정류장별 버스 노선
  bus: [
    { stop: '고잔역 2번 출구', lines: '525, 98, 99-1' },
    { stop: '푸르지오 4차', lines: '98, 99-1' },
    { stop: '홈플러스앞 · 고잔뜰먹거리타운', lines: '55, 71, 76, 98, 99-1' },
    { stop: '안산문화광장', lines: '10, 123, 3, 50, 80B, 80C, 90A, 98, 99-1, N80B, 5609' },
  ],
